...
<head>
  ...
  <title>Jamjam & Neng Yunitasari</title>
...
<body>
  ...
  <section id="hero"
    ...
    <main>
      ...
      <h4>kami : </h4>
      <h3>JAMJAM FIRMAN MAULANA, S.Kom & Neng Yunitasari</h3>
  ...
  <nav class="navbar navbar-expand-md bg-transparent sticky-top mynavbar">
    <div class="container">
      <a class="navbar-brand" href="#">Jamjam</a>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 text-center">
          ...
          <h3>Diselenggarakan pada 2026 di Lebak, Banten.</h3>
      ...
      <div class="row couple">
        <div class="col-lg-6">
          <div class="row">
            ...
            <div class="col-4">
              <img src="img/neng.jpg" alt="Jamjam Firman" class="img-responsive rounded-circle">
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="row">
            <div class="col-4">
              <img src="img/neng1.jpg" alt="Nofariza" class="img-responsive rounded-circle">
            </div>
            <div class="col-8">
              <h3>Neng Yunitasari</h3>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque praesentium aut ipsa perferendis,
                incidunt soluta?</p>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 col-10 text-center">
          ...
          <p class="alamat">Alamat: Kp Muhara RT 008 RW 002  <br> Kel. Ciladaeun Kec. Lebakgedong Kabupaten Lebak</p>

          <iframe
            src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d906.9689057475891!2d106.40673760145756!3d-6.612522285710367!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNsKwMzYnNDYuNSJTIDEwNsKwMjQnMjQuOCJF!5e1!3m2!1sid!2sid!4v1745052139488!5m2!1sid!2sid"
            width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy"
            referrerpolicy="no-referrer-when-downgrade"></iframe>

          <a href="https://maps.app.goo.gl/RjNGy3dYwP6m9rsQ6" target="_blank" class="btn btn-light btn-sm my-3">Klik untuk
            membuka peta</a>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col">
          <ul class="timeline">
            <li>
              <div class="timeline-image" style="background-image: url(img/neng4.jpg);"></div>
  ...
  <section id="gallery" class="gallery">
    <div class="container">
      ...
      <div class="row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 justify-content-center">
        <div class="col mt-3">
          <a href="img/gallery/1.jpg" data-toggle="lightbox" data-caption="Sandhika & Nofa 1" data-gallery="mygallery">
            <img src="img/gallery/thumbnail/1.jpg" alt="Sandhika & Nofa 1" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="https://picsum.photos/id/300/1200/768" data-toggle="lightbox" data-caption="Jamjam & Neng Yunitasari"
            data-gallery="mygallery">
            <img src="https://picsum.photos/id/300/300/400" alt="Jamjam & Neng Yunitasari" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="https://picsum.photos/id/301/1200/768" data-toggle="lightbox" data-caption="Jamjam & Neng Yunitasari"
            data-gallery="mygallery">
            <img src="https://picsum.photos/id/301/300/400" alt="Jamjam & Neng Yunitasari" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="https://picsum.photos/id/302/1200/768" data-toggle="lightbox" data-caption="Jamjam & Neng Yunitasari"
            data-gallery="mygallery">
            <img src="https://picsum.photos/id/302/300/400" alt="Jamjam & Neng Yunitasari" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="https://picsum.photos/id/304/1200/768" data-toggle="lightbox" data-caption="Jamjam & Neng Yunitasari"
            data-gallery="mygallery">
            <img src="https://picsum.photos/id/304/300/400" alt="Jamjam & Neng Yunitasari" class="img-fluid w-100 rounded">
          </a>
        </div>
        <div class="col mt-3">
          <a href="https://picsum.photos/id/305/1200/768" data-toggle="lightbox" data-caption="Jamjam & Neng Yunitasari"
            data-gallery="mygallery">
            <img src="https://picsum.photos/id/305/300/400" alt="Jamjam & Neng Yunitasari" class="img-fluid w-100 rounded">
          </a>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-6">
          <ul class="list-group">
            <li class="list-group-item">
              ...
              123456789 - JAMJAM FIRMAN MAULANA
            </li>
            <li class="list-group-item">
              <div class="fw-bold">DANA</div>
              987654321 - NENG YUNITASARI
            </li>
            <li class="list-group-item">
    ...
    <div class="container">
      <div class="row">
        <div class="col text-center">
          <small class="block">&copy; 2025 jamjam neng . All Rights Reserved.</small>
          <small class="block">Design by <a href="https://instagram.com/jamjamfirman">@jamjamfirman</a>.</small>
...
<?php
    if(isset($_POST["kirim"])) {
      print "<h3> Terimakasih Ucapannya</>h3";
      $nama = $_POST["nama"];
      $ucapan = $_POST["ucapan"];

      $Old = fopen("ucapan.txt", "r+t");
      $Old_ucapan = fread($Old, 1024);

      $Write = fopen("ucapan.txt", "w+");
      $String = 
          "<div class='ucapan'><span>".$nama."</span><br />
          <span>".date("y/m/d")." | " ".date("h:i A")."</span><br />
          <span>".$ucapan."</span></div>\n".$Old_ucapan;
      fwrite($Write, $String);
      fclose($Write);
      fclose($Old);
